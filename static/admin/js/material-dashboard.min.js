            ...
            if (i) {
                ...
                if (s.classList.contains("flex-column")) {
                    ...
                    (n.style.transform = "translate3d(0px," + t + "px, 0px)"),
                        (n.style.width =
                            s.querySelector("li:nth-child(" + a + ")")
                                .offsetWidth + "px"),
            ...
            window.innerWidth < 991
                ? total.forEach(function (n, e) {
                      if (!n.classList.contains("flex-column")) {
                          ...
                          (i.style.width =
                              n.querySelector("li:nth-child(1)").offsetWidth +
                              "px"),
                              (i.style.transform =
    ...
    if (e.getAttribute("checked")) {
        ...
        for (y = 0; y < l.length; y++)
            !l[y].classList.contains("text-white") ||
                ...
                (l[y].classList.remove("text-white"),
                l[y].classList.add("text-dark"));
        ...
        for (var y = 0; y < r.length; y++)
            r[y].classList.contains("text-dark") &&
                (r[y].classList.remove("text-dark"),
                r[y].classList.add("text-white"));
        ...
        for (var y = 0; y < v.length; y++)
            v[y].classList.remove("text-dark"),
                v[y].classList.add("text-white");
